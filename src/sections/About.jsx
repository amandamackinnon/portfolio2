  ...
  return (
    <div className="aboutMe">
      <section className="aboutMe-section">
        ...
        <p>
          I'm a Web & Mobile Developer based in Sweden. My 15+ year career in mainly customer-facing and operational roles across four countries shaped one belief: the best solutions come from understanding people first.
